...
Begin VB.Form frmConnect 
   ...
   Begin VB.Image Image2 
      Height          =   420
      Left            =   9240
      MouseIcon       =   "frmConnect.frx":5A672
      MousePointer    =   99  'Custom
      Top             =   8160
      Width           =   2250
   End
...
RD = Inet1.OpenURL("http://localhost/arduz/u.php?a=list&hamachi=0&v=" & App.Major & "." & App.Minor & "." & App.Revision)
...
MsgBox "Hay una nueva version disponible en la web, para poder jugar nesecitás descargarla."
    If MsgBox("¿Querés descargar la nueva version o parche ahora?", vbYesNo) = vbYes Then
        Call ShellExecute(0, "Open", "localhost/arduz/?a=descargar&v=" & App.Major & "." & App.Minor & "." & App.Revision, "", App.path, 0)
    End If
End If
crearlista RD
End Sub
...
Call ShellExecute(0, "Open", "http://localhost/arduz/index.php?a=mi_cuenta", "", App.path, 0)
End Sub
...
Call ShellExecute(0, "Open", "http://localhost/arduz/?a=ranking", "", App.path, 0)
Exit Sub
End Sub

Private Sub Image6_Click()
Call ShellExecute(0, "Open", "http://localhost/arduz/?a=ayuda", "", App.path, 0)
End Sub
...
Call ShellExecute(0, "Open", "http://localhost/arduz/", "", App.path, 0)
End Sub
